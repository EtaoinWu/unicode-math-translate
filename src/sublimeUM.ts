// from https://github.com/mvoidex/UnicodeMath/blob/master/mathsymbols.py

export const bigTable: { [keyword: string]: string } = {
  exclam: '!',
  octothorpe: '#',
  mathdollar: '$',
  percent: '%',
...
export const defaultAlias: { [keyword: string]: string } = {
  '\\all': '\\forall',
  '\\->': '\\rightarrow',
  '\\-/>': '\\nrightarrow',
  '\\-->': '\\longrightarrow',
